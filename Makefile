...
#    Updated: 2023/10/04 06:01:46 by lmohin           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_COMMAND_TOOLS =	$(addprefix $(COMMANDTOOLS_PATH), get_redirection.c get_pipe.c token_type_and_content.c commands_utils.c commands.c tokens.c)
