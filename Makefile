...
#    Updated: 2023/10/05 00:02:28 by lmohin           ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC_COMMAND_TOOLS =	$(addprefix $(COMMANDTOOLS_PATH), get_redirection.c get_outfile_redir.c get_outfile_append_redir.c get_infile_redir.c get_heredoc.c get_pipe.c token_type_and_content.c commands_utils.c commands.c tokens.c)
